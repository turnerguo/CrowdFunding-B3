...
$active = array("rewards" => false, "login" => false, "payment" => false, "share" => false);
...
<div class="navbar">
    <div class="navbar-inner">
    	...
    	<ul class="nav">
            ...
            <li <?php echo ($active["login"]) ? 'class="active"' : '';?>>
            	<?php if(!empty($this->layoutData->paymentProcess->step1)){?> 
                <a href="<?php echo JRoute::_(CrowdFundingHelperRoute::getBackingRoute($this->layoutData->item->slug, $this->layoutData->item->catslug, "login"));?>">
                (2) <?php echo JText::_("COM_CROWDFUNDING_STEP_LOGIN");?>
                </a>
                <?php }else {?>
                <a href="javascript: void(0);" class="disabled">(2) <?php echo JText::_("COM_CROWDFUNDING_STEP_LOGIN");?></a>
                <?php }?>
            </li>
