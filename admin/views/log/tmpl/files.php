              ...
              ?>
                <tr id="js-file-row<?php echo $i;?>">
                  ...
                  <td class="center nowrap hidden-phone">
                      ...
                      <a href="<?php echo JRoute::_("index.php?option=com_crowdfunding&task=log.remove");?>" data-row-id="js-file-row<?php echo $i;?>" data-filename="<?php echo $this->escape($file);?>" class="btn btn-small hasTooltip js-log-file-remove-btn" title="<?php echo JText::_("JACTION_DELETE");?>"><i class="icon-delete"></i></a>
