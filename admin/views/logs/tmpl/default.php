...
?>
<form action="<?php echo JRoute::_('index.php?option=com_crowdfunding&view=logs'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container" class="span10">
        ...
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search btn-group pull-left">
    			...
    			<input type="text" class="hasTooltip" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_CROWDFUNDING_SEARCH_IN'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_CROWDFUNDING_SEARCH_IN_TOOLTIP'); ?>" />
    		</div>
...
<div class="modal hide fade" id="js-preview-log-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
