	...
	<div id="j-main-container" class="span10">
        ...
        <div id="filter-bar" class="btn-toolbar">
            <div class="filter-search btn-group pull-left">
    			...
    			<input type="text" class="hasTooltip" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_CROWDFUNDING_SEARCH_IN'); ?>" value="<?php echo $this->escape($this->state->get('filter.search')); ?>" title="<?php echo JText::_('COM_CROWDFUNDING_SEARCH_IN_COMMENTS_TOOLTIP'); ?>" />
    		</div>
