...
<form action="<?php echo JRoute::_('index.php?option=com_crowdfunding&view=comments'); ?>" method="post" name="adminForm" id="adminForm">
    <fieldset id="filter-bar">
        <div class="filter-search fltlft">
            <label class="filter-search-lbl hasTip" for="filter_search" title="<?php echo JText::_('COM_CROWDFUNDING_SEARCH_IN_COMMENTS_TOOLTIP'); ?>"><?php echo JText::_('JSEARCH_FILTER_LABEL'); ?></label>
