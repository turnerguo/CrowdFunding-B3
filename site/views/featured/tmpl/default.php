                        ...
                        <div class="cf-caption-info absolute-bottom">
                            ...
                            <div class="row-fluid">
                                <div class="span4">
                                    ...
                                    <div class="uppercase"><?php echo JString::strtoupper(JText::_("COM_CROWDFUNDING_FUNDED")); ?></div>
                                </div>
                                <div class="span4">
                                    <div class="bolder"><?php echo $raised; ?></div>
                                    <div class="uppercase"><?php echo JString::strtoupper(JText::_("COM_CROWDFUNDING_RAISED")); ?></div>
                                </div>
                                <div class="span4">
                                    <div class="bolder"><?php echo $item->days_left; ?></div>
                                    <div class="uppercase"><?php echo JString::strtoupper(JText::_("COM_CROWDFUNDING_DAYS_LEFT")); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
