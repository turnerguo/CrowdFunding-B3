...
<?php if (!empty($this->items)) { ?>
    ...
    <ul class="cf-cat-thumbnails">
    <?php foreach ($this->items as $row) { ?>
        <?php foreach ($row as $item) { ?>

            <li>
                <div class="cf-cat-thumbnail">
                    <a href="<?php echo JRoute::_(CrowdFundingHelperRoute::getCategoryRoute($item->slug)); ?>" class="cf-cat-thumbnail-pic">
                    ...
                    <div class="caption cf-cat-thumnail-content">
                        <h3>
